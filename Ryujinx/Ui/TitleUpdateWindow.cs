                ...
                using (FileStream file = new FileStream(path, FileMode.Open, FileAccess.Read))
                {
                    ...
                    foreach (DirectoryEntryEx fileEntry in nsp.EnumerateEntries("/", "*.nca"))
                    {
                        ...
                        catch (InvalidDataException exception)
                        {
                            ...
                            if (showErrorDialog)
                            {
                                GtkDialog.CreateInfoDialog("PangoNX Debugger - Error", "Add Update Failed!", "The NCA header content type check has failed. This is usually because the header key is incorrect or missing.");
                            }
                        ...
                        catch (MissingKeyException exception)
                        {
                            ...
                            if (showErrorDialog)
                            {
                                GtkDialog.CreateInfoDialog("PangoNX Debugger - Error", "Add Update Failed!", $"Your key set is missing a key with the name: {exception.Name}");
                            }
